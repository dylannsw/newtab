const CONFIG = {
  ...
  commands: [{
    ...
    },
    {
      ...
      color: 'linear-gradient(90deg, #c6ffdd, #fbd786, #f7797d);',
      icon: 'drive',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      color: 'background-image: linear-gradient(62deg, #FBAB7E 0%, #F7CE68 100%);',
      icon: 'firefoxcss',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(90deg, #ed213a, #93291e)',
      icon: 'youtube',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      color: 'url("https://i.imgur.com/vTVqqSw.jpg") no-repeat center center fixed',
      icon: 'Love',
      quickLaunch: false,
    },
  ],
